...
class Train:
    def __init__(self, root):
        ...
        img_top = img_top.resize((1920, 160), Image.BILINEAR)
        ...
        img_bottom = Image.open(
            r"C:\Users\KIIT01\Face Recognition System\images\Group 71.png")
        img_bottom = img_bottom.resize((800, 500), Image.BILINEAR)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root, image=self.photoimg_bottom)
        f_lbl.place(x=100, y=200, width=1300, height=600)
        ...
        b1_1.place(x=600, y=670, width=300, height=60)
